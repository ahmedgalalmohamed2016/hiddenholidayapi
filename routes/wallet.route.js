...
router.post('/merchant/cashin', middleware.mainAuth, merchantMiddleware.merchantAuth, wallet_controller.merchantCashin);
...
router.post('/merchant/summary', middleware.mainAuth, merchantMiddleware.merchantAuth, wallet_controller.merchantSummary);
